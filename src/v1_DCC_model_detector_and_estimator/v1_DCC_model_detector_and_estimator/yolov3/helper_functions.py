...
def det_obj_est_dis(Yolo, image_path, output_path, depth_frame, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    ...
    image = draw_bbox(original_image, bboxes, depth_frame, CLASSES=CLASSES, rectangle_colors=rectangle_colors)
