...
gyrovelocity = [timestamp/1000,0,0,0]
gyroposition = [timestamp/1000,roll,pitch,yaw]
position =[timestamp/1000,0,0,0,roll,pitch,yaw]
velocity = [timestamp/1000,0,0,0,0,0,0]
lastacceldata = [timestamp/1000,0.0,0,0,0,0,0]
lastgyrodata = [timestamp/1000,0,0,0]
time.sleep(1)
